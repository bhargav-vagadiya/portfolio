...
agent = create_agent(
    ...
    system_prompt=(
        ...
        "CATEGORY C - OTHER Questions (Do NOT answer these):\n"
        "  Examples: 'What is banana?',\n"
        " 'What is taj manal', etc. Outside question from bhargav.\n"
        "  → Respond EXACTLY: \"Sounds like an other question! 😄"
        "Please ask query regarding Bhargav only.\"\n\n"
